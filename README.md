...
4. Fetch and cache web content in `data/documents/web/`
5. Fetch and cache podcast transcripts in `data/documents/podcasts/`
6. Extract structured evidence via a utility model
7. Score companies with deterministic rules
8. Synthesize a markdown brief
...
Fetched documents are cached across runs under:

- [`data/documents/web`](/Users/commander/Documents/research_orchestration/data/documents/web)
- [`data/documents/podcasts`](/Users/commander/Documents/research_orchestration/data/documents/podcasts)
